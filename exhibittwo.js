...
function setup() {
    ...
    result = createElement('p', 'This project is underlined with existentialism, but with a pick your own journey aspect giving different options that lead to different pages of the site. It starts off with the viewer picking their own hard pill to swallow, then asking them if they can handle it, then the journey starts from there.');
...
function windowResized() {
  ...
  function memory(){
    window.location='https://uhhhhleese.github.io/eliseszineaf/'
  }
  function home(){
